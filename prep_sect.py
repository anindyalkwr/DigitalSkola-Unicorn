...
<div style="background-color:#080366;padding:1px;border-radius:15px">
    <h3 style="color:white;font-family:calibri;font-size:22pt;text-align:center;">Data Preprocessing and Cleaning</h3>
</div>
"""
...
def prep_section():
    ...
    submenu = st.sidebar.selectbox("Sub Menu",["Visualization","Description"])
    organizer_gender()
